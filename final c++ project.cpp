...
public://public member functions
    ...
    int j_detail() // function declaration and definition for domestic journey
    {
        ...
        cin >> doj;
        cout << "\1.Delhi(1) \t\2.Banglore(2) \t\3.Vizag(3) \t\4.Chennai(4)" << endl << endl;
        ...
        if((src==1 && dest==2) || (src==2 && dest==1))//condition
        {
            ...
            cout << "\1.Indigo(1)\t08:00\t\t11:05\t\tRs10000\t\tRefundable\n";
            cout << "\2.Air India(2)\t14:00\t\t17:05\t\tRs10000\t\tRefundable\n";
            cout << "\3.Vistara(3)\t19:00\t\t22:05\t\tRs10000\t\tRefundable\n";
        }
        ...
        else if((src==1 && dest==3) || (src==3 && dest==1))//condition
        {
            ...
            cout << "Airline:\tDeparture:\tArrival:\tPrice:\t\tCategory:\n";
            cout << "\1.Indigo(1)\t08:00\t\t11:05\t\tRs10000\t\tRefundable\n";
            cout << "\2.Air Asia(2)\t14:00\t\t17:05\t\tRs10000\t\tRefundable\n";
            cout << "\3.Vistara(3)\t19:00\t\t22:05\t\tRs10000\t\tRefundable\n";
        }
        ...
        else if((src==1 && dest==4) || (src==4 && dest==1))//condition
        {
            cout << "\t \t \tFlights Found" << endl << endl;
            cout << "Airline:\tDeparture:\tArrival:\tPrice:\t\tCategory:\n";
            cout << "\1.Indigo(1)\t08:00\t\t11:05\t\tRs20000\t\tRefundable\n";
            cout << "\2.Air Asia(2)\t14:00\t\t17:05\t\tRs25000\t\tRefundable\n";
            cout << "\3.Vistara(3)\t19:00\t\t22:05\t\tRs30000\t\tRefundable\n";
        }
        ...
        else if((src==2 && dest==3) || (src==3 && dest==2))//condition
        {
            cout << "\t \t \tFlights Found" << endl << endl;
            cout << "Airline:\tDeparture:\tArrival:\tPrice:\t\tCategory:\n";
            cout << "\1.Indigo(1)\t08:00\t\t11:05\t\tRs14000\t\tRefundable\n";
            cout << "\2.Air Asia(2)\t14:00\t\t17:05\t\tRs15000\t\tRefundable\n";
            cout << "\3.Vistara(3)\t19:00\t\t22:05\t\tRs18000\t\tRefundable\n";
        }
        ...
        else if((src==2 && dest==4) || (src==4 && dest==2))//condition
        {
            ...
            cout << "\1.Indigo(1)\t08:00\t\t11:05\t\tRs20000\t\tRefundable\n";
            cout << "\2.Air Asia(2)\t14:00\t\t17:05\t\tRs15000\t\tRefundable\n";
            cout << "\3.Vistara(3)\t19:00\t\t22:05\t\tRs20000\t\tRefundable\n";
        }
        else if((src==3 && dest==4) || (src==4 && dest==3))//condition
         {
            cout << "\t \t \tFlights Found" << endl << endl;
            cout << "Airline:\tDeparture:\tArrival:\tPrice:\t\tCategory:\n";
            cout << "\1.Indigo(1)\t08:00\t\t11:05\t\tRs18000\t\tRefundable\n";
            cout << "\2.Air Asia(2)\t14:00\t\t17:05\t\tRs5000\t\tRefundable\n";
            cout << "\3.Vistara(3)\t19:00\t\t22:05\t\tRs15000\t\tRefundable\n";
        }
...
public://public member functions
    ...
    int j_detaili()// function declaration and definition for journey details
    {
        ...
        {
            cout << "Airline:\tDeparture:\tArrival:\tPrice:\t\tCategory:\n";
            cout << "\1.Vistara(1)\t10:00\t\t14:05\t\tRs250000\tRefundable\n";
            cout << "\2.Fly Dubai(2)\t14:00\t\t18:05\t\tRs100000\tRefundable\n";
            cout << "\3.Emirates(3)\t18:00\t\t22:05\t\tRs1200000\tRefundable\n";
        }

        else if((srci==1 && desti==4) || (srci==4 && desti==1))//condition
        {
            cout << "Airline:\tDeparture:\tArrival:\tPrice:\t\tCategory:\n";
            cout << "\1.Vistara(1)\t10:00\t\t14:05\t\tRs255000\tRefundable\n";
            cout << "\2.Fly Dubai(2)\t14:00\t\t18:05\t\tRs2300000\tRefundable\n";
            cout << "\3.Emirates(3)\t18:00\t\t22:05\t\tRs1200000\t\tRefundable\n";
        }
        ...
        else if((srci==1 && desti==5) || (srci==5 || desti==1))//condition
        {
            cout << "Airline:\tDeparture:\tArrival:\tPrice:\t\tCategory:\n";
            cout << "\1.Vistara(1)\t10:00\t\t14:05\t\tRs250000\tRefundable\n";
            cout << "\2.Fly Dubai(2)\t14:00\t\t18:05\t\tRs29000\tRefundable\n";
            cout << "\3.Emirates(3)\t18:00\t\t22:05\t\tRs220000\tRefundable\n";
        }

        else if((srci==2 && desti==3) || (srci==3 && desti==2))//condition
        {
            cout << "Airline:\tDeparture:\tArrival:\tPrice:\t\tCategory:\n";
            cout << "\1.Vistara(1)\t10:00\t\t14:05\t\tRs170000\tRefundable\n";
            cout << "\2.Fly Dubai(2)\t14:00\t\t18:05\t\tRs140000\tRefundable\n";
            cout << "\3.Emirates(3)\t18:00\t\t22:05\t\tRs170000\tRefundable\n";
        }
        ...
        {
            cout << "Airline:\tDeparture:\tArrival:\tPrice:\t\tCategory:\n";
            cout << "\1.Vistara(1)\t10:00\t\t14:05\t\tRs14000\tRefundable\n";
            cout << "\2.Fly Dubai(2)\t14:00\t\t18:05\t\tRs120000\tRefundable\n";
            cout << "\3.Emirates(3)\t18:00\t\t22:05\t\tRs140000\tRefundable\n";
...
public://public members functions
    ...
    {     cout << "\n\n\nHow would you like to pay?:\n";
        ...
        case 2://condition
            ...
            break;
        case 3://condition
            cout << "Banks Available: \1.HDFC Bank(1) \2.ICIC Bank(2) \3.SBI Bank(3) \4.Bank Of Baroda(4) \5.Others(5)";
            cout << "\nSelect your bank:";
            cin >> bank;
